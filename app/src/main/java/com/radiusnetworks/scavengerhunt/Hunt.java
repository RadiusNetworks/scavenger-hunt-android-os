...
public class Hunt {	
    ...
    public static Hunt loadFromPreferneces(Context context) {
        Log.d(TAG, "**** loading from preferneces");
        Hunt hunt = new Hunt();
        SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        Log.d(TAG, "start time from preferences is "+hunt.startTime);
        Log.d(TAG, "device uuid from preferences is "+hunt.deviceUuid);
        Log.d(TAG, "ids from preferences is "+targetIds);
        Log.d(TAG, "found ids from preferences is "+targetIdsFound);
